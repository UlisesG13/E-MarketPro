...
import { useAdminOrdersStore } from '../../../../entities/admin/store/adminOrdersStore';
...
import type { Order, OrderStatus } from '../../../../shared/types/common.types';
...
const OrdersPage: React.FC = () => {
  const { orders, isLoading } = useAdminOrdersStore();
